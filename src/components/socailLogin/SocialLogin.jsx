...
export const SocialLogin = () => {
    ...
    return (
        <div className="flex gap-5 items-center justify-center my-5 md:mx-10">
            <div onClick={facebookHandler} className="md:w-[110px] flex items-center justify-between border rounded-md px-2 py-1 bg-gray-200 hover:bg-gray-50">
                ...
                <span className="text-sm uppercase text-gray-500 font-medium">Facebook</span>
            </div>
