...
export const SocialLogin = () => {
    ...
    return (
        <div className="flex gap-5 items-center justify-center my-5">
            <div onClick={goggleHandler} className="w-12 border rounded-full hover:bg-gray-200">
            ...
            <div onClick={facebookHandler} className="w-12 border rounded-full hover:bg-gray-200">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
